function toggleMode() {
  const html =
    document.documentElement /* se a class light estivesse no body seria const body = document.body.
  ...
  if (html.classList.contains("light")) {
    nomeAlt.setAttribute(
      "alt",
      "Foto da Rebecca e do Júlio sorrindo agasalhados devido ao frio do inverno do Japão. Atrás, montanhas de neve."
    )
  } else {
    nomeAlt.setAttribute(
      "alt",
      "Foto da Rebecca e do Júlio sorrindo agasalhados devido ao frio do inverno do Japão. Atrás, árvores de folhas vermelhas."
    )
  }
}
